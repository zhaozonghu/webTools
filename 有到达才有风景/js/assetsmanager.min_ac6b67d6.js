...
, __generator = this && this.__generator || function(e, r) {
    ...
    function o(t) {
        ...
        for (; u; )
            try {
                if (n = 1,
                i && (a = i[2 & t[0] ? "return" : t[0] ? "throw" : "next"]) && !(a = a.call(i, t[1])).done)
                    return a;
                switch (i = 0,
                a && (t = [0, a.value]),
                t[0]) {
                ...
                default:
                    if (a = u.trys,
                    !(a = a.length > 0 && a[a.length - 1]) && (6 === t[0] || 2 === t[0])) {
                        u = 0;
                        continue
                    }
...
, __decorate = this && this.__decorate || function(e, r, t, o) {
    var n, i = arguments.length, a = 3 > i ? r : null === o ? o = Object.getOwnPropertyDescriptor(r, t) : o;
    if ("object" == typeof Reflect && "function" == typeof Reflect.decorate)
        a = Reflect.decorate(e, r, t, o);
    else
        for (var s = e.length - 1; s >= 0; s--)
            (n = e[s]) && (a = (3 > i ? n(a) : i > 3 ? n(r, t, a) : n(r, t)) || a);
    return i > 3 && a && Object.defineProperty(r, t, a),
    a
}
, RES;
!function(e) {
    ...
    function t(e, r) {
        var t;
        t = e.indexOf(".json") >= 0 ? "legacyResourceConfig" : "resourceConfig",
        o = {
            type: t,
            root: r,
            url: e,
    ...
    var n = function() {
        ...
        return t.prototype.init = function() {
            ...
            e.queue.loadResource(o)["catch"](function(r) {
        ...
        t.prototype.getGroupByName = function(r, t) {
            ...
            for (var i = 0, a = o; i < a.length; i++) {
                var s = a[i]
                  , u = e.config.getResourceWithSubkey(s, !0)
                  , c = u.key
                  , f = (u.subkey,
        ...
        t.prototype.getResourceWithSubkey = function(r, t) {
            ...
            if (t) {
                var a = n ? r + "#" + n : r;
                throw new e.ResourceManagerError(2006,a)
            }
            return null
        }
        ,
        ...
        t.prototype.addResourceData = function(r) {
            ...
            e.fileSystem.addFile(r.url, r.type, r.root, r.extra),
            r.name && (this.config.alias[r.name] = r.url))
        }
        ,
        t.prototype.removeResourceData = function(r) {
            e.hasRes(r.name) && (e.fileSystem.removeFile(r.url),
            this.config.alias[r.name] && delete this.config.alias[r.name])
        }
        ,
...
!function(e) {
    var r = function() {
        ...
        return r.prototype.load = function(e, r, t, o) {
            var n = this;
            if (this.itemListDic[r]) {
                if (!this.dispatcherDic[r]) {
                    var i = new egret.EventDispatcher;
                    this.dispatcherDic[r] = i
                }
                var a = new Promise(function(e, t) {
                    n.dispatcherDic[r].addEventListener("complete", e, null),
                    n.dispatcherDic[r].addEventListener("error", function(e) {
                        t(e.data)
                    }, null)
                }
                );
            ...
            for (var s = e.length, u = 0; s > u; u++) {
                var c = e[u];
                c.groupNames || (c.groupNames = []),
                c.groupNames.push(r)
            }
            ...
            var f = new egret.EventDispatcher;
            this.dispatcherDic[r] = f;
            var l = new Promise(function(e, r) {
                f.addEventListener("complete", e, null),
        ...
        r.prototype.next = function() {
            for (var r = this, t = function() {
                ...
                void o.loadResource(t).then(function(o) {
                    r.loadingCount--,
                    e.host.save(t, o);
                    var n = t.groupNames.shift();
                    0 == t.groupNames.length && (t.groupNames = void 0);
                    var i = r.reporterDic[n];
                    r.numLoadedDic[n]++;
                    var a = r.numLoadedDic[n]
                      , s = r.groupTotalDic[n];
                    if (i && i.onProgress && i.onProgress(a, s),
                    a == s) {
                        ...
                        if (u) {
                            ...
                            var l = r.errorDic[n];
                            delete r.errorDic[n],
                            c.dispatchEventWith("error", !1, {
                                itemList: f,
                                error: l
                            })
                        } else
                            c.dispatchEventWith("complete")
                    }
                    r.next()
                })["catch"](function(o) {
                    if (!o)
                        throw t.name + " load fail";
                    if (!o.__resource_manager_error__)
                        throw o;
                    r.loadingCount--,
                    delete e.host.state[t.root + t.name];
                    var n = r.retryTimesDic[t.name] || 1;
                    if (!(n > r.maxRetryTimes))
                        return r.retryTimesDic[t.name] = n + 1,
                        r.failedList.push(t),
                        void r.next();
                    delete r.retryTimesDic[t.name];
                    var i = t.groupNames.shift();
                    0 == t.groupNames.length && delete t.groupNames,
                    r.loadItemErrorDic[i] || (r.loadItemErrorDic[i] = []),
                    -1 == r.loadItemErrorDic[i].indexOf(t) && r.loadItemErrorDic[i].push(t),
                    r.groupErrorDic[i] = !0;
                    var a = r.reporterDic[i];
                    r.numLoadedDic[i]++;
                    var s = r.numLoadedDic[i]
                      , u = r.groupTotalDic[i];
                    if (a && a.onProgress && a.onProgress(s, u),
                    s == u) {
                        r.groupErrorDic[i];
                        r.removeGroupName(i),
                        delete r.groupTotalDic[i],
                        delete r.numLoadedDic[i],
                        delete r.itemListDic[i],
                        delete r.groupErrorDic[i],
                        delete r.reporterDic[i];
                        var c = r.loadItemErrorDic[i];
                        delete r.loadItemErrorDic[i];
                        var f = r.dispatcherDic[i];
                        f.dispatchEventWith("error", !1, {
                            itemList: c,
                            error: o
                        })
                    } else
        ...
        r.prototype.removeGroupName = function(e) {
            for (var r in this.priorityQueue) {
                for (var t = this.priorityQueue[r], o = 0, n = !1, i = t.length, a = 0; i > a; a++) {
                    var s = t[a];
                    if (s == e) {
                        t.splice(o, 1),
                        n = !0;
        ...
        r.prototype.unloadResource = function(r) {
            ...
            if (o) {
                ...
                1 == r.extra && e.config.removeResourceData(r),
                n
            }
...
!function(e) {
    ...
    e.host = {
        ...
        remove: function(r) {
            delete e.host.state[r.root + r.name],
            delete t[r.url]
        }
    },
    ...
    !function(r) {
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(n) {
                    return [2, new Promise(function(n, i) {
                        ...
                        r.addEventListener(egret.Event.COMPLETE, a, o),
                        r.addEventListener(egret.IOErrorEvent.IO_ERROR, s, o)
                    }
                    )]
                })
            })
                ...
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(c) {
                        ...
                        case 1:
                            ...
                            a = new egret.Texture,
                            a._setBitmapData(o),
                            s = e.resourceConfig.getResource(r.name),
                            s && s.scale9grid && (u = s.scale9grid.split(","),
                            a.scale9Grid = new egret.Rectangle(parseInt(u[0]),parseInt(u[1]),parseInt(u[2]),parseInt(u[3]))),
                            [2, a]
                        }
                    })
                })
            ...
            onLoadStart: function(r, t) {
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(s) {
                        ...
                        case 1:
                            o = s.sent(),
                            n = new Function("require","exports",o),
                            i = function() {}
                            ,
                            a = {};
                            try {
                                ...
                                throw new e.ResourceManagerError(2003,t.name,u.message)
                            }
                            return [2, a]
                        }
                    })
            ...
            onLoadStart: function(r, t) {
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(g) {
                        ...
                        case 1:
                            return o = g.sent(),
                            n = r.resourceConfig.getResource(e.nameSelector(o.file)),
                            n || (i = a(t.url, o.file),
                            n = {
                                name: i,
                                url: i,
                        ...
                        case 2:
                            s = g.sent(),
                            u = o.frames,
                            c = new egret.SpriteSheet(s),
                            c.$resourceInfo = n;
                            for (f in u)
                                l = u[f],
                                s = c.createTexture(f, l.x, l.y, l.w, l.h, l.offX, l.offY, l.sourceW, l.sourceH),
                                l.scale9grid && (p = l.scale9grid,
                                d = p.split(","),
                                s.scale9Grid = new egret.Rectangle(parseInt(d[0]),parseInt(d[1]),parseInt(d[2]),parseInt(d[3])));
                            return r.save(n, s),
                            [2, c]
                        }
                    })
                ...
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(l) {
                        ...
                        case 1:
                            ...
                            return i = "string" == typeof n ? u(t.url, n) : a(t.url, n.file),
                            s = r.resourceConfig.getResource(e.nameSelector(i)),
                            s || (s = {
                                name: i,
                                url: i,
                                type: "image",
        ...
        r.MovieClipProcessor = {
            onLoadStart: function(r, t) {
                ...
                return r.load(t, "json").then(function(i) {
                    ...
                    if (n = r.resourceConfig.getResource(s, !0),
                    !n)
                        throw new e.ResourceManagerError(1001,s);
                    return r.load(n)
                }).then(function(e) {
                    r.save(n, e);
                    var t = e
            ...
            onLoadStart: function(r, t) {
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(i) {
                        ...
                        case 1:
                            return o = i.sent(),
                            n = new e.NewFileSystem(o.resources),
                            o.fileSystem = n,
                            delete o.resource,
                            e.resourceTypeSelector = o.typeSelector,
                            e.resourceNameSelector = o.nameSelector ? o.nameSelector : function(e) {
                                return e
                            }
                            ,
                            [2, o]
            ...
            onLoadStart: function(r, t) {
                return r.load(t, "json").then(function(o) {
                    ...
                    for (var s = n.groups, u = 0, c = o.groups; u < c.length; u++) {
                        var f = c[u];
                        s[f.name] = f.keys.split(",")
                    }
                    for (var l = n.alias, p = a.fsData, d = function(e) {
                        p[e.name] = e,
                        p[e.name].root = i,
                    ...
                    }, g = 0, v = o.resources; g < v.length; g++) {
                        var h = v[g];
                        d(h)
                    }
                    return r.save(t, n),
        ...
        var c = function() {
            ...
            return e.parse = function(r, t, o) {
                ...
                55727696 === i[0] ? e._parseV3(a, t, o) : 559044176 === i[11] ? e._parseV2(a, t, o) : o(a, "pvr parse error!")
            }
            ,
            e._parseV2 = function(r, t, o) {
                var n, i, a = r.header, s = a[0], u = a[1], c = a[2], f = a[3], l = a[4], n = (a[5],
                a[6]), p = (a[7],
                a[8],
                a[9],
                a[10]), d = (a[11],
                a[12]), g = 255, v = 24, h = 25, _ = l & g, R = p > 0;
            ...
            e._parseV3 = function(r, t, o) {
                ...
                default:
                    ...
                    console.log("unknow pixel format::" + s)
                }
                var u = 52 + a[12];
        ...
        r.PVRProcessor = {
            onLoadStart: function(e, r) {
                return __awaiter(this, void 0, void 0, function() {
                    var t, o, n, i, a, s, u, f, l, p, d, g, v;
                    return __generator(this, function(h) {
                        switch (h.label) {
                        case 0:
                            return [4, e.load(r, "bin")];
                        case 1:
                            for (t = h.sent(),
                            o = 512,
                            n = 512,
                            ...
                            l = 0; l < u.length; l++)
                                ...
                                case "body":
                                    s.position += 2,
                                    d = s.readUnsignedInt(),
                                    f = s.buffer.slice(s.position, s.position + d),
                                    s.position += d;
                                    break;
                                case "ext":
                                    s.position += 6,
                                    o = s.readUnsignedShort(),
                                    n = s.readUnsignedShort(),
                                    i = s.readUnsignedShort(),
                                    a = s.readUnsignedShort()
                                }
                            return g = this,
                            c.parse(f, function(e) {
                                var r = new egret.BitmapData(e);
                                r.format = "pvr",
                                v = new egret.Texture,
                                v._setBitmapData(r),
                                v.$initData(i, a, o, n, 0, 0, o, n, r.width, r.height)
                            }, function() {
...
!function(e) {
    ...
    function t(r, t) {
        if (t.indexOf("://") >= 0) {
            ...
            t = e.path.normalize(t + "/"),
            r = r.replace(t, "");
        return e.setConfigURL(r, t),
        R || (R = new _),
        R.loadConfig()
    }
    function o(e, r, t) {
    ...
    var _ = function(r) {
        ...
        t.prototype.loadGroup = function(r, t, o) {
            ...
            return this._loadGroup(r, t, i).then(function(t) {
                ...
                for (var o = t.itemList, i = o.length, a = 0; i > a; a++) {
                    var s = o[a];
                    delete s.promise,
                    e.ResourceEvent.dispatchResourceEvent(n, e.ResourceEvent.ITEM_LOAD_ERROR, r, s)
                }
        ...
        t.prototype.getResAsync = function(r, t, o) {
            var n = this
              , i = r
              , a = e.config.getResourceWithSubkey(r, !0)
              , s = a.r
              , u = a.subkey;
            return e.queue.loadResource(s).then(function(n) {
                e.host.save(s, n);
                var a = e.processor.isSupport(s);
                return a && a.getData && u && (n = a.getData(e.host, s, r, u)),
                t && t.call(o, n, i),
                n
            }, function(r) {
                return e.host.remove(s),
                e.ResourceEvent.dispatchResourceEvent(n, e.ResourceEvent.ITEM_LOAD_ERROR, "", s),
                Promise.reject(r)
            })
        }
        ,
        t.prototype.getResByUrl = function(r, t, o, n) {
            ...
            if (!a && (n || (n = e.config.__temp__get__type__via__url(r)),
            a = {
                name: r,
                url: r,
                type: n,
            ...
            e.config.addResourceData(a),
            a = e.config.getResource(r),
            !a))
                throw "never";
            return e.queue.loadResource(a).then(function(r) {
                return e.host.save(a, r),
                t && a && t.call(o, r, a.url),
                r
            }, function(r) {
                return e.host.remove(a),
                e.ResourceEvent.dispatchResourceEvent(i, e.ResourceEvent.ITEM_LOAD_ERROR, "", a),
                Promise.reject(r)
            })
        }
        ,
            ...
            __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(s) {
                    ...
                    case 4:
                        return [2, !0];
                    case 5:
                        return a = e.config.getResource(r),
                        a ? [4, o(a)] : [3, 7];
                    case 6:
                        return s.sent(),
                        [2, !0];
...
!function(e) {
    var r = function(r) {
        ...
        return __extends(t, r),
        t.dispatchResourceEvent = function(r, o, n, i, a, s) {
            void 0 === n && (n = ""),
            void 0 === i && (i = void 0),
            void 0 === a && (a = 0),
            void 0 === s && (s = 0);
